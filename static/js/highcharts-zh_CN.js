        ...
        var defaultOptionsZhCn={
            ...
            plotOptions:{
                ...
                ohlc:{
                                tooltip:{
                                        split:false,
                                    pointFormat:'<span style="color:{point.color}">●</span> <b> {series.name}</b><br/>'+"开：{point.open}<br/>"+"高：{point.high}<br/>"+"低：{point.low}<br/>"+"收：{point.close}<br/>"}},candlestick:{tooltip:{split:false,pointFormat:'<span style="color:{point.color}">●</span> <b> {series.name}</b><br/>'+"开：{point.open}<br/>"+"高：{point.high}<br/>"+"低：{point.low}<br/>"+"收：{point.close}<br/>"}}}};H.setOptions(defaultOptionsZhCn)})(Highcharts);
